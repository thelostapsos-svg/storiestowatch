...
(function(){
  ...
  // ---- partner slot (house ad -> media kit; rotates category imagery; text sits on the dark side, never the hero) ----
  if(!/mediakit/i.test(location.pathname)){
    var PIMGS=[
    ...
    var pFoot = document.querySelector('footer');
    if(pFoot && pFoot.parentNode){
      ...
      pFoot.parentNode.insertBefore(pb, pFoot);
    }
  }
